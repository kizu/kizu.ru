...
Но они не всемогущи. Они не умеют правильно работать с вертикальным выравниванием текста. Причём проблема описана в [соответствующей спецификации][bug1], достаточно прочитать самый последний абзац и отметить две проблемы:
