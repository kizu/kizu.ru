В [первой статье про Jekyll]({{% LinkTo going-jekyll %}}) я [упомянул]({{% LinkTo going-jekyll %}}#proseio) про Prose.io. Пришло время рассказать про этот сервис чуть подробнее.
...
- Чуть-чуть про то, что ещё можно сделать: вместо простой ссылки на issues можно сделать комментирование — например, аналогично тому, как сделано https://github.com/sirbrad/sirbrad.github.com/issues/3 и https://bradleyfew.com/github-powered-comments/
- Eventually consistent — https://prose.io/help/eventually-consistent.html
- советы для jekyll https://prose.io/help/handbook.html
- …
