...
<!-- ![Котики](flex-baseline.jpg "{:width='756' height='478'}") -->
...
[^safari]: Кстати, в последних Сафари, внезапно, блок с overflow ведёт себя не по спецификации. <!-- span="2" -->
...
{{<Partial src="examples/flex-baseline3.html" screenshot="true" alt="Скриншот из Firefox 27.0" />}}
...
{{<Partial src="examples/flex-baseline5.html" screenshot="true" alt="Скриншот из Firefox 27.0" />}}
...
{{<Partial src="examples/flex-baseline6.html" screenshot="true" alt="Скриншот из Firefox 27.0" />}}
